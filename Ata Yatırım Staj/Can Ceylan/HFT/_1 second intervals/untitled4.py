...
if __name__ == "__main__":
    ...
    for cluster in clusters:
        for i in range(len(cluster)):
            ...
            asset1 = cluster[i]
            print(asset1)
            grouped = variable_dict[asset1].resample('1S')['price'].agg(['max','min'])
            ...
            for critical_value, threshold in critical_values:
                ...
                for timestamp, row in filtered_data.iterrows():
                    ...
                    group = variable_dict[asset1].between_time(start_time.time(), end_time.time())
                ...
                for asset1 in cluster:
                    for asset2 in cluster:
                        if asset1 != asset2:
                            ...
                            file_path = f"P:\Can Ceylan\HFT\_1 second intervals\Resample 1S Results\{asset1}_{asset2}_{money:.2f}_{critical_value:.1f}_{threshold:.1f}_{interval:.0f}.csv"
