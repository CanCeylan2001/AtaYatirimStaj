...
if __name__ == "__main__":
    ...
    intervals = [0.3, 0.5, 1, 3, 5] # in seconds
            ...
            for cluster in clusters:
                for asset1 in cluster:
                    for asset2 in cluster:
                        if asset1 != asset2:
                            myDataFrames[(asset1,asset2,critical_value,interval)] = pd.DataFrame(columns= ['timestamp', f'{asset1}_price_change', f'{asset2}_price_change', 'interval'])
            ...
            for timestamp, group in grouped:
                ...
                for critical_value in critical_values:
                    if percentage_change1 >= critical_value:
                        ...
                        first_price1 = df['price'].idxmin()
                        last_price1 = df['price'].idxmax()
                                    ...
                                    for interval in intervals:
                                        ...
                                        if selected_rows.size != 0:
                                            ...
                                            myData = {
                                                ...
                                                'interval' : ((selected_rows.iloc[last_price2].name - timestamp).microseconds) / 1000000
